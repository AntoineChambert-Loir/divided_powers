...
ideal.of_rel (divided_power_algebra.rel R M)
...
/-- The divided power algebra of a module M is the quotient of the polynomial ring
by the ring relation defined by divided_power_algebra.rel, as a graded algebra  -/
def divided_power_graded_algebra := graded_quot_alg R ((weighted_homogeneous_submodule R (λ (nm : ℕ × M), nm.fst))) (divided_power_algebra.relI R M)(divided_power_algebra.relI_is_homogeneous R M)
